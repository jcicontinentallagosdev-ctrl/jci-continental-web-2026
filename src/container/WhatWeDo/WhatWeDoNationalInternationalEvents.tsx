...
const WhatWeDoNationalInternationalEvents = () => {
          ...
          <div className="w-full">
            <div className="embla overflow-hidden" ref={emblaRef}>
              <div className="embla__container flex gap-3 lg:gap-6">
                {nationalInternationalEvents.map(event => (
                  <div
                    key={event.id}
                        ...
                        <div className="flex flex-col gap-5 flex-1">
                          <div className="flex flex-col gap-5">
                            <div className="flex flex-col gap-4">
                              {/* Event Type Badge */}
                              <div className="bg-[#e6f5fa] flex gap-2 items-center justify-center px-3 py-2 rounded-[20px] w-fit">
                                <div className="flex flex-col font-inter font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#026c8e] text-[12px] text-nowrap uppercase">
                              ...
                              <div className="flex flex-col gap-3">
                                ...
                                <div className="flex flex-col gap-4">
                                  ...
                                  <div className="flex gap-3 items-center">
                                    ...
                                    <span className="font-['Inter'] font-normal text-[#546165] text-[12px] lg:text-base leading-[24px] lg:leading-6">
                                      {event.date}
                                    </span>
                                  </div>
...
export default WhatWeDoNationalInternationalEvents;
